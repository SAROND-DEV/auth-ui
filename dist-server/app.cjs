...
let users = [
    {
        ...
        username: 'test',
        password: '123',
        about: 'Я тестовый пользователь номер один. Я никогда не пропадаю между запусками api!'
    },
    {
        id: 2,
        username: 'test2',
        password: '234',
        about: 'Я тестовый пользователь номер два. Я так же никогда не пропадаю между запусками api!'
    }
]
...
app.post('/login', (req, res) => {
    ...
    if (user) {
        ...
        const token = jwt.sign({ id: user.id, username: user.username }, 'topsecretkey', { expiresIn: 129600 })
